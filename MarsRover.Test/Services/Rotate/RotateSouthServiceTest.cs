...
{
    [TestFixture]
    public class RotateSouthServiceTest
    {
        private RoverPositionModel _roverPositionModel;
        private RotateSouthService _service;

        [SetUp]
        public void Setup()
        {
            //Given
            _service = new RotateSouthService();
        ...
        [Test]
        public void It_Should_Return_East_When_Direction_Is_Left()
        {
            //when
        ...
        [Test]
        public void It_Should_Return_West_When_Direction_Is_Right()
        {
            //when
